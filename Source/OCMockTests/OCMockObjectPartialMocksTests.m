...
//	XCTAssertEqualObjects(@"hi", [mock uppercaseString], @"Should have returned stubbed value");
//}
...
//	XCTAssertEqualObjects(@"HELLO2", [mock uppercaseString], @"Should have returned value from real object.");
//}
...
- (void)testCallsToSelfInRealObjectStructReturnAreShadowedByPartialMock
{
  ...
  XCTAssertTrue(CGRectEqualToRect(NSZeroRect, [mock methodRect1]), @"Should have called through to stubbed method.");
}
...
//	XCTAssertEqual(numKVOCallbacks, 2, @"did not get mock KVO notification");
	...
	[mock stopMocking];
	XCTAssertEqualObjects([realObject class], origClass, @"Classes different after stopMocking");
//	XCTAssertEqualObjects(object_getClass(realObject), kvoClass, @"KVO class different after stopMocking");
